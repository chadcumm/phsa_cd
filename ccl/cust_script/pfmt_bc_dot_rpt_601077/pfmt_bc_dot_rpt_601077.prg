...
******************************************************************************/
drop program pfmt_bc_dot_rpt_601077:dba go
create program pfmt_bc_dot_rpt_601077:dba
...
if (requestin->request->SKIP_LOCK_IND = 1)
	call writeLog(build2("->SKIP_LOCK_IND = 1 exiting"))
	go to exit_script
