...
drop program bc_amb_st_anticoag_pl_alt:dba go
create program bc_amb_st_anticoag_pl_alt:dba
...
if (vFormCnt <= NumberofFormsOutput) qualify = 1 endif
	call echo(build2("Qualify=",Qualify)) 
	call echo(build2("vFormCnt=",vFormCnt))
	call echo(build2("form_date=",format(form_date,";;q")))
detail
if (qualify = 1)
