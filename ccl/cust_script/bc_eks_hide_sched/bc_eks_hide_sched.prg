/***********************************************************************************************************************
  Program Name:       	bc_eks_hide_sched
  Source File Name:   	bc_eks_hide_sched.prg
  Program Written By: 	Chad Cummings
  Date:  			  	17-Aug-2022
  Program Purpose:   	Hide Scheduling Event
...
drop program bc_eks_hide_sched go
create program bc_eks_hide_sched 
...
update into sch_event set active_ind = 0 where sch_event_id = link_sch_event_id
commit
